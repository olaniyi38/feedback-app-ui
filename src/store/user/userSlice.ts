...
const signUpUser = createAsyncThunk(
	"user/sign-up",
	async (userCredentials: UserCredentials): Promise<User> => {
		const res = await fetch(
			"https://go-feedback-api.onrender.com/auth/sign-up",
			{
				method: "POST",
...
const signInUser = createAsyncThunk(
	"user/sign-in",
	async (userCred: UserCredentials): Promise<User> => {
		const res = await fetch(
			"https://go-feedback-api.onrender.com/auth/sign-in",
			{
				method: "POST",
