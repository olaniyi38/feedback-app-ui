...
const FeedbacksSkeleton = () => {
  return (
    <div className='flex flex-col gap-4 p-4 pt-8 pb-16'>
      <SkeletonTheme baseColor='#a0a0a0' highlightColor='#dddddd'>
        {
          Array(4).fill(1).map((item, i) => {
            return (
              <div key={i} className=" bg-white relative flex flex-col gap-2 md:gap-x-8 md:flex-row rounded-lg p-6">
                ...
                <div className="flex justify-between md:order-1 font-semibold  ">
                  <button disabled className={`flex self-start`}>
